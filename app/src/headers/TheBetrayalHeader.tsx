...
export const TheBetrayalHeader = () => {
  ...
  if (itsMe) {
    return <Trans i18nKey="header.the-betrayal.me" components={TransComponents} />
  }
  return <Trans i18nKey="header.the-betrayal.player" values={{ player: name }} components={TransComponents} />
}
