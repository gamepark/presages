...
export const TheLawHeader = () => {
  ...
  const minus15 = useLegalMove((move: MaterialMove) => isCustomMoveType(CustomMoveType.TheLaw)(move) && move.data === -15)
  const plus15 = useLegalMove((move: MaterialMove) => isCustomMoveType(CustomMoveType.TheLaw)(move) && move.data === 15)
