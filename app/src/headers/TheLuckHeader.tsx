...
export const TheLuckHeader = () => {
  ...
  if (itsMe) {
    return <Trans i18nKey="header.the-luck.me" components={TransComponents} />
  }
  return <Trans i18nKey="header.the-luck.player" values={{ player: name }} components={TransComponents} />
}
